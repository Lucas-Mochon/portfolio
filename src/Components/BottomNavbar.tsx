      ...
      >
        ...
        {mobileMenuOpen && (
          <motion.div
            ...
            className="absolute bottom-20 left-1/2 -translate-x-1/2 w-48 bg-neutral-900/90 backdrop-blur-md rounded-2xl shadow-xl border border-white/20 overflow-hidden flex flex-col p-4 space-y-2"
          >
            {navItems.map((item) => (
              <NavLink
                key={item.name}
            ...
            <div className="border-t border-white/10 pt-2 mt-2">
              <p className="text-xs text-neutral-400 px-4 py-2">{t("skill")}</p>
