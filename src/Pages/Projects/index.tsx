...
import ruleILiveByImage from "../../assets/pictures/projects/rulesILiveBy/dahsboard.png"
...
export default function ProjectPage() {
  ...
  const projects: Project[] = [
    ...
    },
    {
      key: "ruleILiveBy",
      type: "web",
      ...(t("projectsList.ruleILiveBy", { returnObjects: true }) as Omit<Project, "key" | "type">)
    }
  ]
              ...
              <div className="space-y-6 sm:space-y-8 md:space-y-10 text-left">
                ...
                <div className="flex flex-col lg:flex-row gap-6 sm:gap-8 md:gap-12 items-start">
                  <div className="w-full lg:w-[700px] lg:flex-shrink-0">
                    <div className="relative w-full  aspect-[1900/1050] lg:max-h-[400px] rounded-lg sm:rounded-xl overflow-hidden border border-white/10 shadow-xl bg-neutral-900 group-hover:shadow-xl group-hover:shadow-cyan-400/20 transition-all duration-300">
                      <img
                  ...
                  <div className="flex-1 space-y-4 sm:space-y-5 md:pt-2 min-w-0">
                    <p className="text-base sm:text-lg font-semibold text-cyan-400">{project.stack}</p>
                    <p className="text-lg sm:text-xl text-neutral-100 leading-relaxed">{project.description}</p>
